function [y_est, sigma_est] = bm4d_tunable(z, distribution, sigma, profile, do_wiener, verbose, N1, N2, Nstep, Ns, lambda_thr4D, tau_match)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
